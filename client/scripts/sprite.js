...
function initSprites(img) {
	...
	s_bird = [
		new Sprite(img, 221, 115, 30, 31),
		new Sprite(img, 221, 146, 30, 31),
		new Sprite(img, 221, 177, 30, 31)
	];
	...
	s_text = {
		...
		GameOver: new Sprite(img, 59, 138, 94, 20),
		GetReady: new Sprite(img, 59, 159, 87, 23)
	}
	s_buttons = {
		...
		Ok: new Sprite(img, 120, 201, 39, 14),
		Start: new Sprite(img, 160, 201, 39, 14)
	}

	s_score = new Sprite(img, 138, 56, 113, 58);
	s_splash = new Sprite(img, 0, 117, 59, 60);

	s_numberS = new Sprite(img, 0, 183, 6, 7);
	s_numberB = new Sprite(img, 0, 192, 7, 10);
